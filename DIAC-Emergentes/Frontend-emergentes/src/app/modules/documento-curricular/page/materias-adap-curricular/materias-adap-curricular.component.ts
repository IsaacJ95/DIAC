...
export class MateriasAdapCurricularComponent implements OnInit {
  ...
  asignaturasListSeleccionadas: Course[] = []
  ...
  fillArrayCourses(e: any, asignatura: Course) {
    ...
    // const asignaturaArr = new Set(this.asignaturasListSeleccionadas);
    // const idsAsignaturaArr = new Set(this.asignaturasSeleccionadas);
    // let resultAsignatura = [...asignaturaArr];
    // // let resultIdsAsignatura = [...idsAsignaturaArr];
    // this.registerDocumentCurricular.asignaturaListSelected = resultAsignatura
