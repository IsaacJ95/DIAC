...
export class RegisterDocumentCurricularService {
  ...
  criteriasSeleccionados: number[] = []
  destrezasSeleccionados: number[] = []
  recursosSeleccionados: string[] = []
  profesionalesSeleccionados: string[] = []
  objetivosSeleccionados: number[] = []
  methodologiasSeleccionados: string[]=[]
  resoursesSeleccionados: string[]=[]
  resultsSeleccionados: string[]=[]

  docenteListSelected: Teacher[] = []
  asignaturaListSelected: Course[] = []
  criteriasListSelect: Criteria[] = []
  destrezasListSelect: Destreza[] = []
  objetivosListSelect: Objective[] = []
  methodologiasListSelect: string[]=[]
  resoursesListSelect: string[]=[]
  resultsListSelect: string[]=[]
